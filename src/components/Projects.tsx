...
import nadiEmbalagens from "@/assets/nadi-embalagens.png";
...
const techIcons: Record<string, { icon: React.ElementType; color: string }> = {
  ...
  Zod: { icon: SiTypescript, color: "#3068B7" },
};

const projects = [
  {
    title: "Nadi Embalagens",
    subtitle: "E-commerce Completo (Site, Painel & API)",
    description:
      "Solução completa de e-commerce dividida em três frentes: Site rápido focado na conversão, Painel Administrativo robusto para gestão, e API RESTful escalável integrada a pagamentos e tarefas assíncronas.",
    image: nadiEmbalagens, // Adicionado a imagem
    liveUrl: "https://nadiembalagens.com.br",
    technologies: [
      "React",
      "TypeScript",
      "Python",
    ...
    features: [
      "Frontend (Site): Catálogo responsivo com React, Tailwind CSS, Shadcn UI e validação Zod",
      "Frontend (Painel): Dashboard gerencial com React, Ant Design, Redux Toolkit e React Query",
      "Backend (API): Django REST Framework, PostgreSQL, JWT Auth e Swagger/OpenAPI",
      "Integrações: Pagamentos via MercadoPago e armazenamento S3 (boto3)",
      "Background Jobs: Processamento assíncrono com Celery e Redis",
      "Relatórios: Geração automática de planilhas Excel e PDFs de etiquetas",
    ],
    type: "Freelancer",
    year: "2026",
  },
