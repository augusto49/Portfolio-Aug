...
const experienceCategories = [
  {
    ...
    items: [
      ...
      "Integração entre aplicativos mobile (Flutter/React Native/Ionic) e backends (Django/Node.js/.NET)",
      "Gerenciamento de bancos de dados relacionais (Oracle, SQL Server, MySQL, PostgreSQL)",
  ...
  },
  {
    ...
    items: [
      "Desenvolvimento de aplicativos híbridos com Flutter/Dart, React Native, Angular, Ionic e Capacitor para Android e iOS",
  ...
  },
  {
    ...
    items: [
      ...
      "Desenvolvimento backend com Node.js e ecossistema .NET (C#, ASP.NET MVC)",
      "Integração e manipulação de bancos de dados relacionais (Oracle, SQL Server)",
  ...
  },
  {
    ...
    items: [
      ...
      "Conhecimento em DevOps e automação de esteiras CI/CD (Azure Pipelines, Codemagic)",
